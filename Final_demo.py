...
def progm():
    ...
    number_values=[43,9,27,19,13,25,39]
    
    len_to_name={"43":"ART_MODERNE","9":"ASIAN","27":"BOHEMIAN","19":"COASTAL_TROPICAL","13":"FRENCH_COUNTRY","25":"INDUSTRIAL","39":"MINIMAL"}
    ...
    for i in overall:
        ...
        while True:
            ...
            if(inp==5 and flag == "true"):
                ...
                index_value=list(df_mini['SR_NO']).index(start)
        if(Dflag == 'true' or i == len(overall)):
            progm()
